...
<head>
    @if(App::environment('production'))
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-101105392-3"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-101105392-3');
        </script>
    @endif
    <meta charset="utf-8">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3">
        ...
        <div class="w-full flex-grow md:flex md:items-center md:w-auto hidden md:block mt-2 md:mt-0 bg-gray-900 z-20"
            ...
            <ul class="list-reset md:flex flex-1 items-center px-4 md:px-0">
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="{{ route('youtube-playlist-latest.index') }}"
                       class="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-gray-100 border-b-2 {{ request()->routeIs('youtube-playlist-latest.*') ? 'text-blue-400 border-blue-400' : 'text-gray-300 border-gray-900'  }}  hover:border-red-400">
                        <i class="fab fa-youtube fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">YouTube Playlist First</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
