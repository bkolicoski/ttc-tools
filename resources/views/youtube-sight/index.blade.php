...
@section('content')
    <div class="text-center w-full md:w-3/4 mx-auto">
        ...
        <a href="{{ route('youtube-sight.privacy-policy') }}" class="underline hover:no-underline inline-block mt-4">Privacy Policy</a>&nbsp;&nbsp;&nbsp;
        <a href="{{ route('youtube-sight.terms') }}" class="underline hover:no-underline inline-block mt-4">Terms of Service</a>
    </div>
@stop
